...
<div class="col-md-8 col-sm-8 col-xs-12">
    ...
    <section class="panel">
        <div class="panel-body">
            ...
            <div class="text-center form-group col-sm-2" style="padding-top: 3%">
                <a id="get_available" class="btn btn-default btn-success">
                    <i class="ace-icon fa fa-check bigger-160"></i> Search
                </a>
            </div>
